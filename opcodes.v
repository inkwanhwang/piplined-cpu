...
`define FUNCT_ADD       4'b0001
`define FUNCT_SUB       4'b0010
`define FUNCT_OR        4'b0011
`define FUNCT_AND       4'b0100
`define FUNCT_SLL       4'b0101
`define FUNCT_SRL       4'b0110
`define FUNCT_XOR       4'b0111
`define FUNCT_BEQ       4'b1001
`define FUNCT_BNE       4'b1010
`define FUNCT_BLT       4'b1011
`define FUNCT_BGE       4'b1100
`define FUNCT_BRA       4'b0000
